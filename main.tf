...
resource "aws_instance" "backend" {
  ...
  # Use the NAME of the profile resource

  iam_instance_profile = aws_iam_instance_profile.coursera_profile.name



  # Add this line to prevent the Race Condition

  depends_on = [aws_iam_instance_profile.coursera_profile]
